...
Sofern sinnvoll werden alle Parameter über **typsichere Python Dataclasses** verwaltet keine Plain Dicts oder Magic Strings.
...
* Ermöglicht A/B Testing verschiedener Algorithmen
